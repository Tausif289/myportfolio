...
const Work = ({ isdarkmode }) => {
  return (
    ...
    >
      ...
      <div className="absolute top-10 left-10 w-72 h-72 bg-blue-400/20 blur-3xl rounded-full -z-10 pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-80 h-80 bg-purple-400/25 blur-3xl rounded-full -z-10 pointer-events-none" />
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-32 bg-gradient-to-t from-blue-500/10 to-transparent blur-2xl rounded-full -z-10 pointer-events-none" />
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {workData.map((project, index) => (
          <a
            ...
            className="block overflow-hidden rounded-2xl shadow-lg group border border-gray-200 dark:border-gray-700 hover:scale-105 transition-transform duration-300"
          >
            {/* 🔹 Project Image */}
            <Image
              src={project.bgImage}
